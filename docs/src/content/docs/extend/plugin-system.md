...
See [Hooks](/customize/hooks/) for the full hook API and configuration details.
...
See [Settings and Permissions](/customize/settings-and-permissions/) for the full `settings.json` reference.
...
- [Hooks](/customize/hooks/) — detailed hook API and event documentation
- [Settings and Permissions](/customize/settings-and-permissions/) — managing settings and plugin activation
