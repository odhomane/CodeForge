...
Most users can skip this page unless they want the internals behind `/ps`.
...
- [Skills Reference](/reference/skills/) — the `/ps` skill is also documented in the skills catalog
