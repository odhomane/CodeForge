...
- [Agents Reference](/reference/agents/) — detailed per-agent documentation with usage examples
- [Skills Reference](/reference/skills/) — skills that agents leverage for domain expertise
- [Hooks](/customize/hooks/) — how hook scripts integrate with the agent lifecycle
