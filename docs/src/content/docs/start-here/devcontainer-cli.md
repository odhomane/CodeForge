...
:::note[Alternate Setup Path]
This page is the best path for terminal-first users. If you are new to CodeForge and do not specifically want a CLI-only workflow, use [Install in VS Code](./install-in-vscode/) instead.
:::
...
Unlike VS Code, the devcontainer CLI does not auto-forward ports. Services running inside the container won't be accessible on your host unless you set up forwarding manually.
:::
...
- [Start Your First Session](/start-here/first-session/) — start using CodeForge with Claude Code
- [Accessing Services](/use/accessing-services/) — detailed forwarding setup guide
- [Install in VS Code](/start-here/install-in-vscode/) — the recommended setup path
