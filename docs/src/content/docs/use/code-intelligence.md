...
:::note[Default vs Optional]
`ast-grep` and `tree-sitter` are part of the normal CodeForge tool surface. LSP support is more precise, but it is disabled by default and must be enabled separately.
:::
...
- [CodeForge LSP Plugin](../extend/plugins/codeforge-lsp/) — LSP server configuration
- [CLI Tools Reference](/reference/cli-tools/) — CLI commands for these tools
- [Skills Reference](/reference/skills/) — pattern-writing guidance

## Next Steps

- Need exact commands: [CLI Tools Reference](/reference/cli-tools/)
- Want to enable LSP: [Optional Components](/customize/optional-components/)
